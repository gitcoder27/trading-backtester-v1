...
from strategies.supertrend_rsi_scalper import SuperTrendRSIScalper
...
def main():
    ...
    strategy = MomentumScalper(params=strategy_params)
    # strategy = SuperTrendRSIScalper(params=strategy_params)
